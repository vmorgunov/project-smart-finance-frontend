      ...
      <InputWrrapDiv matches={matches}>
        {!matches.isMobile && (
          <DateWrrap matches={matches}>
            ...
            <DateSend>
              <WrrapFieldForm>
                {dateDirty && dateError && (
                  <WrrapErrorText matches={matches}>{dateError}</WrrapErrorText>
                )}
                <DatePicker
                  locale="ru"
        ...
        <WrrapFieldForm>
          {descriptionDirty && descriptionError && (
            <WrrapErrorText label={true} matches={matches}>
              {descriptionError}
            </WrrapErrorText>
          )}
          <Input
        ...
        <WrrapFieldForm>
          {categoryDirty && categoryError && (
            <WrrapErrorText matches={matches}>{categoryError}</WrrapErrorText>
          )}
          <SelectCategry
        ...
        <TransactionValueWrrap matches={matches}>
          <WrrapFieldForm>
            {sumDirty && sumError && (
              <WrrapErrorText matches={matches}>{sumError}</WrrapErrorText>
            )}
            <Currency
