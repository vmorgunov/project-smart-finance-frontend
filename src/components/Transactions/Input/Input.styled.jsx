...
export const InputStyle = styled.input`
  ...
  border-left: 2px solid ${({ borderColor }) => borderColor ? borderColor : 'var(--bg-color)'};
  border-top: 2px solid ${({borderColor}) => borderColor ? borderColor : 'var(--bg-color)'};
  border-bottom: ${({ border, borderColor }) =>
    `${border?.bottom || border?.bottom === 0
    ?
    border.bottom
    :
    2}px solid ${borderColor ? borderColor : 'var(--bg-color)'}`};
